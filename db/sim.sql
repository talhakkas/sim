...
) ENGINE=MyISAM AUTO_INCREMENT=10524 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `d_survey` VALUES (010101,'Akciğer grafisi (tek yön)','null','null'),(010102,'Akciğer grafisi (iki yön)','null','null'),(010103,'Akciğer grafisi (üç yön)','null','null'),(010104,'Akciğer grafisi (üç yön) baryumlu','null','null'),(010105,'Akciğer Grafisi Apikolordotik','null','null'),(010106,'Akciğer Grafisi Lateral Dekibitüs','null','null'),(010107,'Akciğer Grafisi Lateral','null','null'),(010108,'Kalp teleradyogram (tek yön)','null','null'),(010109,'Kalp teleradyogram (iki yön)','null','null'),(010110,'Kalp teleradyogram (üç yön)','null','null'),(010111,'Kalp teleradyogram (üç yön) baryumlu','null','null'),(010112,'Floroskopi-Skopi','null','null'),(010113,'Sinüs (Water\'s) Grafisi','null','null'),(010114,'Schuller grafisi (Karşılaştırmalı)','null','null'),(010115,'Stenvers Grafisi (Karşılaştırmalı)','null','null'),(010116,'Mandibula Grafisi','null','null'),(010117,'Temporo-mandibuler grafi (Karşılaştırmalı)','null','null'),(010118,'Sella spot grafisi','null','null'),(010119,'Kafa grafisi (tek yön)','null','null'),(010120,'Kafa grafisi (iki yön)','null','null'),(010121,'Kafa grafisi (Dört yön)','null','null'),(010122,'Servikal Vertebra Grafisi (tek yön)','null','null'),(010123,'Servikal Vertebra Grafisi (iki yön)','null','null'),(010124,'Servikal Vertebra Grafisi (üç yön)','null','null'),(010125,'Servikal Vertebra Grafisi (dört yön)','null','null'),(010126,'Dorsal (Torakal) Vertebra Grafisi AP','null','null'),(010127,'Dorsal (Torakal) Vertebra Grafisi 2 Yönlü','null','null'),(010128,'Dorsal (Torakal) Vertebra Grafisi 3 Yönlü','null','null'),(010129,'Lomber Vertebra Grafisi AP','null','null'),(010130,'Lomber Vertebra Grafileri (iki yön)','null','null'),(010131,'Lomber Vertebra Grafileri (üç yön)','null','null'),(010132,'Lomber Vertebra Grafileri (dört yön)','null','null'),(010133,'L5-S1 spot grafisi','null','null'),(010134,'Skolyoz tetkiki','null','null'),(010135,'Pelvis Grafisi','null','null'),(010136,'Pelvis Grafisi(iki Yön)','null','null'),(010137,'Pelvis Grafisi (Sakro İliak Eklem)','null','null'),(010138,'Pelvimetri (iki yön)','null','null'),(010139,'Kalça Eklemi Grafisi (Tek Yön) -Sol','null','null'),(010140,'Kalça Eklemi Grafisi (Tek Yön) -Sol','null','null'),(010141,'Kalça Eklemi Grafisi (iki yön) -Sağ','null','null'),(010142,'Kalça Eklemi Grafisi (iki yön) -Sol','null','null'),(010143,'Kalça Grafisi Karşılaştırmalı (Tek Yön)','null','null'),(010144,'Kalça Grafisi (iki yön) Karşılaştırmalı','null','null'),(010201,'Beyin MR','null','null'),(010202,'Diffüzyon MR','null','null'),(010203,'Perfüzyon MR','null','null'),(010204,'BOS Akım MR','null','null'),(010205,'Hipofiz MR','null','null'),(010206,'Kulak MR','null','null'),(010207,'Orbita MR','null','null'),(010208,'Nazofarinks MR','null','null'),(010209,'Boyun MR','null','null'),(010210,'Akciğer ve Mediasten MR','null','null'),(010211,'Kardiyak MR','null','null'),(010212,'Anjiyografi MR','null','null'),(010213,'Spektroskopi MR','null','null'),(010214,'Üst Abdomen MR','null','null'),(010215,'Alt Abdomen MR','null','null'),(010216,'Meme MR','null','null'),(010217,'Dinamik MR','null','null'),(010218,'Kolanjiografi MR','null','null'),(010219,'Ürografi MR','null','null'),(010220,'Servikal Vertebra MR','null','null'),(010221,'Torakal Vertebra MR','null','null'),(010222,'Lomber Vertebra MR','null','null'),(010223,'Myelografi MR','null','null'),(010224,'Omuz Eklem MR -Sağ','null','null'),(010225,'Omuz Eklem MR -Sol','null','null'),(010226,'Dirsek Eklem MR -Sağ','null','null'),(010227,'Dirsek Eklem MR -Sol','null','null'),(010228,'El-Bilek Eklem MR -Sağ','null','null'),(010229,'El-Bilek Eklem MR -Sol','null','null'),(010230,'Kalça Eklem MR -Sağ','null','null'),(010231,'Kalça Eklem MR -Sol','null','null'),(010232,'Sakro-İliak Eklem MR -Sağ','null','null'),(010233,'Sakro-İliak Eklem MR -Sol','null','null'),(010234,'Diz Eklem MR -Sağ','null','null'),(010235,'Diz Eklem MR -Sol','null','null'),(010236,'Ayak-Bilek Eklem MR -Sağ','null','null'),(010237,'Ayak-Bilek Eklem MR -Sol','null','null'),(010238,'Temporo-Mandibula Eklem MR -Sağ','null','null'),(010239,'Temporo-Mandibula Eklem MR -Sol','null','null'),(010240,'Artrografi MR','null','null'),(010301,'Beyin BT','null','null'),(010302,'Hipofiz(sella) BT','null','null'),(010303,'Temporal BT','null','null'),(010304,'BT hava veya opaklı sisternografi','null','null'),(010305,'Nazofarenks BT Aksiyel','null','null'),(010306,'Nazofarenks BT Koronal','null','null'),(010307,'Paranasal sinüs BT Aksiyel','null','null'),(010308,'Paranasal sinüs BT Koronal','null','null'),(010309,'BT tempomandibular eklem','null','null'),(010310,'Larenks BT','null','null'),(010311,'Maksillofasial BT Aksiyel','null','null'),(010312,'Maksillofasial BT Koronal','null','null'),(010313,'Orbita BT','null','null'),(010314,'BT dental tomografi','null','null'),(010315,'Alt abdomen(pelvik) BT','null','null'),(010316,'Üst abdomen BT','null','null'),(010317,'Boyun Tomografisi','null','null'),(010318,'Vertebra (4 adet) BT','null','null'),(010319,'Extremite (20-50cm)BT','null','null'),(010320,'Toraks BT','null','null'),(010321,'Yüksek rezol.AC BT (HRCT)','null','null'),(010322,'BT yüksek rezolusyonlu akciğer ekspratuar','null','null'),(010323,'BT anjiografi tek anatomik bölge','null','null'),(010324,'BT kantitatif tomografi (kals.skor. - BTBMD g','null','null'),(010325,'Üç boyutlu(3D) BT','null','null'),(010326,'BT sanal endoskopi','null','null'),(010327,'Dinamik BT incelemesi','null','null'),(010328,'BT perfüzyon çalışmaları','null','null'),(010329,'BT eşliğinde girişimsel tetkik (biyopsi vb.)','null','null'),(010330,'BT radyoterapi planlaması için tomografi','null','null'),(010331,'BT tomografi diğer','null','null'),(010332,'Pompa BT','null','null'),(010401,'Abdomen (üst) US','null','null'),(010402,'Suprapubik pelvik US','null','null'),(010403,'Hepatobilier US','null','null'),(010404,'Renal US','null','null'),(010405,'Üriner sistem US','null','null'),(010406,'Tiroid US','null','null'),(010407,'Transfontanel US','null','null'),(010408,'Boyun US','null','null'),(010409,'Paratis bezi US','null','null'),(010410,'Submandibuler bez US','null','null'),(010411,'Toraks US','null','null'),(010412,'Yüzeysel doku US','null','null'),(010413,'Skrotal US','null','null'),(010414,'Eklem US (tek taraf)','null','null'),(010415,'Kalça eklemi US','null','null'),(010416,'Transrektal US','null','null'),(010417,'Transvajinal US','null','null'),(010418,'Obstetrik US','null','null'),(010419,'Endoskopik US','null','null'),(010420,'Orbita US (bilateral)','null','null'),(010421,'US Eşliğinde parasentez - torosentez','null','null'),(010422,'Görüntüleme eşliğinde biyopsi (US)','null','null'),(010423,'Perkütan Akciğer absesi drenajı','null','null'),(010424,'Perkütan abse drenajı','null','null'),(010425,'Perkütan Nefrostomi','null','null'),(010426,'Perkütan ampiyem drenajı','null','null'),(010501,'Alt Ekstremite venöz sistemi - tek taraflı RD','null','null'),(010502,'Alt ekstremite venöz sistemi - iki taraflı RD','null','null'),(010503,'Alt Ekstremite arteriel sistemi - tek taraflı','null','null'),(010504,'Alt Ekstremeti Arterial sistemi - iki taraflı','null','null'),(010505,'Üst Ekstremite venöz sistem tek taraflı RDUS','null','null'),(010506,'Üst ekstremite venöz sistem iki taraflı RDUS ','null','null'),(010507,'Üst Ekstremite arteriel sistem tek taraflı RD','null','null'),(010508,'Üst Ekstremite Arterial Sis.iki taraflı RDUS ','null','null'),(010509,'Orbita RDUS','null','null'),(010510,'Tiroid RDUS','null','null'),(010511,'Transrektal RDUS','null','null'),(010512,'Karotis renkli Doppler US','null','null'),(010513,'Vertebral arter RDUS','null','null'),(010514,'Renal RDUS ( bilateral)','null','null'),(010515,'Penil RDUS','null','null'),(010516,'Skrotal RDUS','null','null'),(010517,'Portal ven RDUS','null','null'),(010518,'Abdominal aorta RDUS','null','null'),(010519,'Kitle lezyonu RDUS','null','null'),(010520,'Meme RDUS','null','null'),(010521,'Obstetrik RDUS','null','null'),(010522,'Transfontonel RDUS','null','null'),(010523,'Transkranial RDUS','null','null');
...
INSERT INTO `parent` VALUES (0101,'Direkt Radyografi İstem Formu'),(0102,'Manyetik Rezonans Görüntüleme İstem Formu'),(0103,'Bilgisayarlı Tomografi Görüntüleme istem Form'),(0104,'Ultrasonografi Görüntüleme istem Formu'),(0105,'Doppler Ultrasonografi İstem Formu'),(0201,'Rutin Biyokimya'),(0202,'Hemogram'),(0203,'Rutin İdrar Tetkiki'),(0204,'Kan Gazı'),(0205,'İlaç Düzeyleri'),(0206,'BOS Biyokimya'),(0207,'HPLC Testleri'),(0208,'İdrar Biyokimya'),(0209,'Hormon Testleri'),(0401,'Merkez Mikrobiyoloji Tetkik İstem Formu'),(0402,'Hematolojik Testler Formu'),(0403,'İmmünolojik Testler Formu'),(0404,'Merkez Lab. Adli Toksikoloji İstem Formu'),(0501,'Pozitron Emisyon Tomografi'),(0502,'I-131 MIBG Sintigrafisi İstem Formu'),(0503,'In-111 Octreotid Sintigrafisi İstem Formu'),(0504,'Tc-99m Hmpao İşaretli Lökosit Sintigrafisi İs');
...
-- Dump completed on 2011-09-28 22:47:35
