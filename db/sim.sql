...
CREATE TABLE `node` (
  ...
  `type` varchar(5) COLLATE utf8_turkish_ci NOT NULL,
...
INSERT INTO `node` VALUES (1,'Çiçek Serası Çalışanı merdivenden düştü','m.jpg','																																																																				33 yaşındaki Hamdi Mersin, çiçek serasında ilaçlama yaptıktan sonra, çiçek serasının tavanındaki bir hasarı gidermek için merdivene çıkarken, kendini kötü hissetmiş, bulantısı olmuş, kısa süreli bir baygınlık geçirmiş, gözleri kararmış ve 5 basamak yukarıdan yere düşmüştür. Düşme sırasında boyun ve bel bölgesini zemindeki beton çıkıntıya çarpmıştır. Kafasına ise bir darbe almadığını belirtmiştir. Doktor olarak görev yaptığınız, çiçek serasının 50 metre uzağında bulunan aile hekimliği merkezinden, hastaya müdahale etmeniz için çağrıldınız. 																																																																		','Bundan sonraki yaklaşımınız ne olur?',' Hastalara ilk acil müdahalenin, 112 acil ambulans merkezi tarafından yapılmasının gerektiğini, bu nedenle aile hekimliği kliniğini terk edemeyeceğimi belirtirim. Bu belirtilen hususu ilgili klinik muayene defterine kayıt ederim.      ::2,, Hastanın durumunu görmek ve gerekirse tıbbi müdahale etmek için, varsa yardımcı sağlık personeli eşliğinde, yoksa bizzat kendim acil hastaya müdahale etmek için çiçek serasına giderim. ::3,, Aile hekimliği merkezi sorumlusunun resmi iznini beklerim. Gerekli izin alınınca olay yerine giderim. ::4','dal',4,1,0),(30,'bar','','','','  foo::9','dal',22,0,0),(31,'zoooooooooo','','','','vadd::3,,foo::2,,bar::14','dal',30,0,0),(3,'Doğru','','								','Olay yerine gitmeniz, hekimin yasal sorumluluklarından hangisi içine girer?','<input type=text><br>						\r\nAmbulans gelir  ::5','dal',2,0,1),(4,'Hata','','','Olay yerine gidilmeyerek hekimin hangi yasal sorumluluğu yerine getirilmemiş oldu?',' <input type=text><br>\r\nTry again -- olgu sonu::1','dal',1,0,1),(5,'Ambulans geldi','','				5 dakika içinde gerekli tıbbi aletleriniz ile olay yerine ulaştınız. 112 Ambulans merkezine haber verilmesini sağladınız. Sonrasında bir paramedik sağlık memuru da, size yardımcı olabileceğini belirterek sizinle beraber hasta başına geldi. \r\nHasta seranın içinde, açık kapının yanındaki kanepede uzanmaktadır. Halen bulantısı olduğunu belirten hasta, doktor bey bana yardımcı olur musunuz, kendimi iyi hissetmiyorum demektedir ? Kanepenin yanında, ağzı açık metal kutular bulunmaktadır. Hasta karın ağrısı şikayetininde olduğunu belirtmekte ve yardım istemektedir. ','Bundan sonraki aşamada ne yaparsınız?','Olay yeri ve çevresini hızlıca incelerim Aynı anda havayolu, solunum dolaşım kontrolü için hastayı değerlendiririm. Kanepe yanındaki teneke kutuların ne için kullanıldığını sorarım ::6','dal',3,0,0),(6,'Doğru','','						Doktor bey bunlar senelerdir çiçek serasında kullandığımız tarım ilaçlarının kutuları. Çiçeklerin üzerinde yerleşen böceklerin öldürülmesi için kullanıyoruz. Ancak bugün ilaçlamada kullanılan kimyasal maddeyi yeni temin ettiğimiz için kutusunu burada depolamadık. Burada yok isterseniz, siz hastaya müdahale ederken ilgili tarım ilacı kutusunu incelemeniz için size getirebiliriz. 		','Bundan sonraki aşamada ne yaparsınız?','Hastanın zehirlenmiş olabileceğini de düşünüp, yeni kullanıldığı belirtilen tarım ilacı kutusunu da getirmelerini isterim ve derhal hastanın öyküsünü alıp, muayenesine geçerim.::7,,Hastanın, <input type=text>::8','dal',5,0,0),(7,'Hata','','				Paramedik konuşur. Doktor bey öncelikle hastanın ve sağlık çalışanlarının güvenliği için hastanın seradan uzak havadar bir yere transportunu öneriyorum. ','','		Try again--Olgu sonu::7			','dal',0,0,0),(8,'Transport','','								Hasta seranın içinde, açık kapının yanındaki kanepede uzanmaktadır. Halen bulantısı olduğunu belirten hasta, doktor bey bana yardımcı olur musunuz, kendimi iyi hissetmiyorum demektedir ? Kanepenin yanında, ağzı açık metal kutular bulunmaktadır. Hasta karın ağrısı şikayetininde olduğunu belirtmekte ve yardım istemektedir.','Hastanın transportu sırasında nelere dikkat edersiniz?','										hastanın, hasta yakınlarının da yardımı ile bir battaniye üzerine alınarak, belirtilen yere taşınmasını sağlarım.::10,,Hastanın <input type=text>::11','dal',30,0,0),(10,'Hata','','				paramedik konuşur: Doktor bey öncelikle hastanın boynuna boyunluk takılması ve sert taşıma tahtası üzerinde olası boyun ve bel zedelenmesine yönelik olarak dikkatlice taşınmasını öneriyorum. ','','					Try again--Olgu sonu::8','dal',0,0,0),(11,'Hastanın uygun şartlarda transportu acil olarak sağlandı. Sonrasında havayolu, solunum ve dolaşım de','olgu.jpg','								Resimde görüldüğü şekilde sera içinde ilaçlama yaptığını, sonrasında bulantı hissinin olduğunu, ancak işlerini bugün tamamlaması gerektiğini bu nedenle seranın içinde tamirat işi için çıktığı merdiven üzerinde iken fenalaşıp 5 basamaklı merdivenden düştüğünü, seranın zemininde bulunan beton çıktıya çarptığını, boynunu ve belini incittiğini, halen bulantısı ve terlemeleri olduğunu belirtti. 								','Sera çalışanının mevcut resim ve öykü kayıtları doğrultusunda şikayetlerine neden olabilecek nedenler nelerdir?','											devam::12																			','dal',0,0,0),(12,'Doğru','','				Halen açık alanda bir set zemin üzerinde yatan hastanın gömleğinin yaka bölgesinde boyundaki künt travmatik yaralanmadan kaynaklanan kan bulaşı görülmekte, aktif kanama izlenmemektedir.','Düşündüğünüz ön tanılar doğrultusunda, hastanın tedavisinde acilen yapılması gereken hangi işlem hastanın yaşamının kurtulması açısından önemlidir ? ','					Hastanın gömleğinin düğmelerini açmasını söyler, pantolonunu çıkartmasını söyleyip, tüm vücuduna hızlıca bakar, patolojik lezyonları not eder ve elbiselerini tekrar giymesi için yakınlarının yardım etmesini sağlarım.::13,,Öncelikle, <input type=text>::14','dal',0,0,0),(13,'Hata','','				','','	Try again--olgu sonu::12			','dal',0,0,0),(14,'Devam','','	Hastanın gelen ambulans ile tam teşekkülü devlet hastanesi acil servisine sevki gerçekleşmiştir. Ambulans gelene kadar bol ılık su ile vücudu yıkanmış ve üzerine temiz bir çarşaf örtülmüştür. Tarım ilacı ile kontaminasyon şüphesi olan elbiseleri imha edilmek üzere tehlikeli tıbbi atık çöpüne atılmıştır.			','Hangi tetkikleri istersiniz','					','dal',0,0,0),(2,'Hata','','																','Olay yerine gidilmeyerek hekimin hangi yasal sorumluluğu yerine getirmemiş oldunuz?','<input type=text><br>\r\n														try again -- olgu sonu ::1','dal',1,0,0);
...
INSERT INTO `people` VALUES (32977301484,'emin','eker','bal19',1,1,'32977301484.jpg'),(11111111111,'bal19','bal19','bal19',1,1,'11111111111.png'),(22768864182,'Gökhan','Demir','159654kafkef55',1,1,'22768864182.jpeg'),(0,'','','',0,0,'people/0.jpg'),(233,'','','',0,0,'people/233.jpg');
...
-- Dump completed on 2011-08-22 14:49:03
