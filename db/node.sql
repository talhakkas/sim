...
--
-- Anamakine: localhost
-- Üretim Zamanı: 15 Eylül 2011 saat 17:30:42
...
(14, 8, 'Hastanın taşınması', NULL, 'Hasta taşınmasında yakınları battaniye üzerine almak istediler.', 'Hastanın transportu sırasında nelere dikkat edersiniz?', 'Hastanın, hasta yakınlarının da yardımı ile bir battaniye üzerine alınarak, belirtilen yere taşınmasını sağlarım.::9,,Hastanın transportu sırasında önce,;;doğru yanıt::10', 'dal', 0, 0, 0, 1),
(15, 9, 'Hata: boyunluk', NULL, 'Doktor bey öncelikle hastanın boynuna boyunluk takılması ve sert taşıma tahtası üzerinde olası boyun ve bel zedelenmesine yönelik olarak dikkatlice taşınmasını öneriyorum.', '', 'Devam etmek için tıklayınız.::10', 'dal', 0, 0, 0, 1),
...
(23, 17, 'Tedavi', NULL, 'Tarım ilacı zehirlenmesine yönelik tedavi yaklaşımınızı (Basmaklar halinde belirtin) belirtiniz.', '', 'Yanıtınızı aşağıdaki alana yazıp gönder tuşuna tıklayınız.;;doğru yanıt::18', 'dal', 0, 0, 0, 1),
...
(31, 25, 'Yorum', NULL, '::', 'Ne düşünüyorsunuz?', 'Yorumunuzu aşağıdaki alana girip gönder tuşuna tıklayınız.;;doğru yanıt::22', 'dal', 0, 0, 0, 1);
