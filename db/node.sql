...
(14, 8, 'Hastanın taşınması', NULL, 'Hasta taşınmasında yakınları, hastayı battaniye üzerine taşımak istemektedir.', 'Hastanın transportu sırasında nelere dikkat edersiniz?', 'Hastanın, hasta yakınlarının da yardımı ile bir battaniye üzerine alınarak, belirtilen yere taşınmasını sağlarım.::9,,Hastanın transportu sırasında önce,;;doğru yanıt::10', 'dal', 0, 0, 0, 1),
